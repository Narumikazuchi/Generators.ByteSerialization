...
public sealed class SerializeCodeWriter
{
                                   ...
                                   ref Int32 varCounter)
    {
            ...
            array.ElementType.IsUnmanagedSerializable())
        {
            ...
            m_CodeBuilder.AppendLine($"{indent}    pointer += (Int32){GlobalNames.NAMESPACE}.TypeLayoutSerializationHandler.Default.Serialize(buffer[pointer..], {GlobalNames.NAMESPACE}.TypeLayout.CreateFrom<{array.ToFrameworkString()}>());");
            m_CodeBuilder.AppendLine($"{indent}}}");
                                   ...
                                   ref Int32 varCounter)
    {
        ...
        else
        {
            ...
            m_CodeBuilder.AppendLine($"{indent}buffer[pointer++] = 0x1;");
            m_CodeBuilder.AppendLine($"{indent}pointer += (Int32){GlobalNames.NAMESPACE}.TypeLayoutSerializationHandler.Default.Serialize(buffer[pointer..], {GlobalNames.NAMESPACE}.TypeLayout.CreateFrom<{type.ToFrameworkString()}>());");
                                      ...
                                      ref Int32 varCounter)
    {
        ...
        foreach (INamedTypeSymbol derivedType in derivedTypes)
        {
            ...
            m_CodeBuilder.AppendLine($"{indent}    {{");
            m_CodeBuilder.AppendLine($"{indent}        buffer[pointer++] = 0x1;");
            m_CodeBuilder.AppendLine($"{indent}        pointer += (Int32){GlobalNames.NAMESPACE}.TypeLayoutSerializationHandler.Default.Serialize(buffer[pointer..], {GlobalNames.NAMESPACE}.TypeLayout.CreateFrom<{derivedType.ToFrameworkString()}>());");
