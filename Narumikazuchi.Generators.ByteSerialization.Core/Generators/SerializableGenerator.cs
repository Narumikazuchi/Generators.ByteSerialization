...
public sealed partial class SerializableGenerator
{
                                       ...
                                       SourceProductionContext context)
    {
        ...
        String linqReferenceIfRequired = String.Empty;
        if (__Shared.LinqReferenceRequired(fields))
        {
            linqReferenceIfRequired = "\r\nusing System.Linq;";
        }
        ...
        if (__Shared.UnsafeKeywordRequired(compilation: semanticModel.Compilation,
                                           fields: fields))
        {
...
using System;{linqReferenceIfRequired}
