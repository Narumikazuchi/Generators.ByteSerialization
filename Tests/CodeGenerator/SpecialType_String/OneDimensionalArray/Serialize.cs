...
{
    static public Byte[] Run(String[] graph)
    {
...
public class Application
{
    static public UInt32 Run(String[] graph)
    {
...
public class Application
{
    static public unsafe Byte[] Run(String[] graph)
    {
        Byte[] buffer = new Byte[16];
...
public class Application
{
    static public void Run(String[] graph)
    {
...
public class Application
{
    static public async Task Run(String[] graph, CancellationToken cancellationToken)
    {
        using MemoryStream stream = new MemoryStream();
