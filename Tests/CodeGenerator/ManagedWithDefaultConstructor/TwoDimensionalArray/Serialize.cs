...
namespace Tests.CodeGenerator.ManagedWithDefaultConstructor.TwoDimensionalArray;
...
{
    static public Byte[] Run(Person[,] graph)
    {
...
public class Application
{
    static public UInt32 Run(Person[,] graph)
    {
...
public class Application
{
    static public unsafe Byte[] Run(Person[,] graph)
    {
        Byte[] buffer = new Byte[16];
...
public class Application
{
    static public void Run(Person[,] graph)
    {
...
public class Application
{
    static public async Task Run(Person[,] graph, CancellationToken cancellationToken)
    {
        using MemoryStream stream = new MemoryStream();
