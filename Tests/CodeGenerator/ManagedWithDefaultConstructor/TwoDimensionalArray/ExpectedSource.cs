...
static public class ExpectedSource
{
    ...
    public const String HANDLER_FILENAME = @"Narumikazuchi.Generators.ByteSerialization.Core\Narumikazuchi.Generators.ByteSerialization.Generators.SerializableGenerator\Narumikazuchi.Generated.Internals.ByteSerialization.Handler.Array[Person+2].g.cs";
            ...
            for (var _var3 = 0; _var3 < _var1; _var3++)
            {
                for (var _var4 = 0; _var4 < _var2; _var4++)
                {
                    ...
                    if (buffer[pointer++] == 0x1)
                    {
                        ...
                        pointer += Unsafe.SizeOf<Narumikazuchi.Generators.ByteSerialization.TypeIdentifier>();
                        if (_var6 != Narumikazuchi.Generators.ByteSerialization.TypeIdentifier.CreateFrom(typeof(Person)))
                        {
                            throw new Narumikazuchi.Generators.ByteSerialization.WrongTypeDeserialization(typeof(Person));
                        }
                        var _var7 = default(String);
                        if (buffer[pointer++] == 0x1)
                        {
                            ...
                            pointer += Unsafe.SizeOf<Narumikazuchi.Generators.ByteSerialization.TypeIdentifier>();
                            if (_var8 != Narumikazuchi.Generators.ByteSerialization.TypeIdentifier.CreateFrom(typeof(String)))
                            {
                            ...
                            _var7 = new String(MemoryMarshal.Cast<Byte, Char>(buffer[pointer..(pointer + _var9)]));
                            pointer += _var9;
                        }
                        else
                        {
                        ...
                        var _var13 = Unsafe.As<Byte, DateOnly>(ref MemoryMarshal.GetReference(buffer[pointer..]));
                        pointer += Unsafe.SizeOf<DateOnly>();
                        var _var14 = Unsafe.As<Byte, Guid>(ref MemoryMarshal.GetReference(buffer[pointer..]));
